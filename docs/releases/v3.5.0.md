# Registry Add-On Release 3.5.0

## Changelog

- :warning: Updated Harbor to version 2.14.0. Please check the [Upgrade path section](#upgrade-path).
...
- Updated alert rules for Harbor, using [Sysdig's Promcat rules](https://github.com/sysdiglabs/promcat-resources/blob/master/resources/harbor/alerts-v2.2.yaml), adapting them to work with Prometheus Operator's CRDs.
